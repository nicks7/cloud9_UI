...
export default function Welcome() {
    ...
    <div className="bg-white">
        { showApp && <FormInput />}
      <div className={`${showWelcome} relative isolate`}>
        ...
        <div className="mx-auto max-w-2xl py-20 sm:py-20 lg:py-20">
          <div className="hidden sm:mb-8 sm:flex sm:justify-center">
            <div className="relative rounded-full py-1 px-3 text-sm leading-6 text-gray-600 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
              Announcing our team <span className="text-green-800 text-2xl font-bold">Cloud9</span> tool to assess Sustainability in AWS Cloud.{' '}
            </div>
          </div>
          <div className="text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">
              Find the Sustainability status of AWS resources for a given stack name.
            </p>
